...
<body>
  ...
  <section class="section-top">
      ...
      <div class="container-fluid">
        <div class="logo">
          <a href="logout"><img class="navbar-brand-item light-mode-item" src="assets/images/logo.png"
              alt="logo"></a>
          <h1 class="title-logo"><span>ALUNO</span>WEB</h1>
        </div>
        <nav>
          ...
          <div class="slideout-sidebar">
            <ul>
                ...
                <li><a href="list_buy_historic">Histórico</a></li>
    ...
    <br>
    <br>
    <h1 class="Subtitulo_Resp"><span>Histórico de Compras</span></h1>
    <br>
  </section>
  <br>
  <div class="jumbotron">
    <h1></h1>
    <h5>Esta sessão tem como objetivo consultar o histórico de compras realizados pelos alunos </h5>
  </div>
  </div>
  <hr>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      <?php for($i=0;$i<count($buyList);$i++){?>
            <tr>
                <td><?php echo $buyList[$i]->getQuantity(); ?></td>
                <td><?php echo $buyList[$i]->getValueTotal(); ?></td>
            <td><?php echo $buyList[$i]->getNameProduct(); ?></td>
            <td><?php echo $buyList[$i]->getNameStudent(); ?></td>
            <td> 
            <td>
            </td>
            </tr>
